...
type node = { str : string ; childs : int list }

let suffix_tree = {str=""; childs=[]}
...
(*
  str already concatened
  pos starting at last pos (fast way)

*)
let rec buildSuffixTree str pos =
1

(*

  Esta solução irá correr 100 000 + 100 000 vezes
